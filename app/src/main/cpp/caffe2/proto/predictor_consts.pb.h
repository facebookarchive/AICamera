...
void protobuf_InitDefaults_predictor_5fconsts_2eproto();
...
class PredictorConsts : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.PredictorConsts) */ {
 public:
  PredictorConsts();
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_predictor_5fconsts_2eproto_impl();
  friend void  protobuf_AddDesc_predictor_5fconsts_2eproto_impl();
