...
void protobuf_InitDefaults_hsm_2eproto();
...
class NodeProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.NodeProto) */ {
 public:
  NodeProto();
  virtual ~NodeProto();
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_hsm_2eproto_impl();
  friend void  protobuf_AddDesc_hsm_2eproto_impl();
  friend void protobuf_AssignDesc_hsm_2eproto();
  friend void protobuf_ShutdownFile_hsm_2eproto();
...
class TreeProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.TreeProto) */ {
 public:
  TreeProto();
  virtual ~TreeProto();
...
class HierarchyProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.HierarchyProto) */ {
 public:
  HierarchyProto();
...
class PathProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.PathProto) */ {
 public:
  PathProto();
  virtual ~PathProto();
...
class PathNodeProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.PathNodeProto) */ {
 public:
  PathNodeProto();
