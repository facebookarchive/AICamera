...
void protobuf_InitDefaults_prof_5fdag_2eproto();
...
class ProfDAGProto : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.ProfDAGProto) */ {
 public:
  ProfDAGProto();
 ...
 private:
  ...
  float mean_;
  float stddev_;
  friend void  protobuf_InitDefaults_prof_5fdag_2eproto_impl();
  friend void  protobuf_AddDesc_prof_5fdag_2eproto_impl();
...
class ProfDAGProtos : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:caffe2.ProfDAGProtos) */ {
 public:
  ProfDAGProtos();
